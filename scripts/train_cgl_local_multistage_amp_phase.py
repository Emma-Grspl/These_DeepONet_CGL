...
def rollout_multistage_models(models, rollout_windows, trajectory, cfg_dict, device):
    ...
    with torch.no_grad():
        for step in range(n_steps):
            model = select_stage_model(models, rollout_windows, float(trajectory["t_values"][step]))
